            ...
            try {
                ...
                state.value.error =
                    error instanceof Error
                        ? error.message
                        : `Request getAll ${moduleName} failed`;
                throw error;
            } finally {
        ...
        getById: async (id: number) => {
            ...
            try {
                ...
                state.value.error =
                    error instanceof Error
                        ? error.message
                        : `Request getById ${singularNames[moduleName]} failed`;
                throw error;
            } finally {
                state.value.isLoading = false;
            }
        ...
        create: async (newItem: New<T>) => {
            ...
            try {
                ...
                state.value.error =
                    error instanceof Error
                        ? error.message
                        : `Failed to create ${singularNames[moduleName]}`;
                throw error;
            } finally {
                state.value.isLoading = false;
            }
        ...
        update: async (id: number, item: Updatable<T>) => {
            ...
            try {
                ...
                state.value.error =
                    error instanceof Error
                        ? error.message
                        : `Failed to update ${singularNames[moduleName]}`;
                throw error;
            } finally {
                state.value.isLoading = false;
            }
        ...
        delete: async (id: number) => {
            ...
            try {
                ...
                state.value.error =
                    error instanceof Error
                        ? error.message
                        : `Failed to delete ${singularNames[moduleName]}`;
                throw error;
            } finally {
                state.value.isLoading = false;
            }
