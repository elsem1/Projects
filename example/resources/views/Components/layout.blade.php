            ...
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <img class="h-8 w-8" src="https://laracasts.com/images/logo/logo-triangle.svg" alt="Semper Incorporated">
                    </div>
        ...
        <div class="md:hidden" id="mobile-menu">
            ...
            <div class="border-t border-gray-700 pb-3 pt-4">
                <div class="flex items-center px-5">
                    ...
                    <div class="ml-3">
                        <div class="text-base font-medium leading-none text-white">Sempi</div>
                        <div class="text-sm font-medium leading-none text-gray-400">Sempi@laracasts.com</div>
                    </div>
